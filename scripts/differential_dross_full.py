"""Offline Dross (2+) clean/reference differential; never runs the game."""
...
def main() -> int:
    ...
    dross_bosses = pools["dross"]
    dross_refs = _refs(dross_bosses)

    special = tuple(load_stb(args.resources / "rooms/00.special rooms.stb"))
    dross = tuple(load_stb(args.resources / "rooms/28.dross.stb"))
